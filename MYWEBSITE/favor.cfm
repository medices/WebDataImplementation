            ...
            <div id="wrapper" class="container" style="margin-top: 2em; margin-bottom: 2em">
                ...
                <div id="main-content" class="row">
                    ...
                    <div id="center" class="col-sm-9 order-last" style="text-align: center">
                        ...
                        <legend>Highlighted Favorites</legend>
                        <div>
                            <h3>Recommended Bestsellers</h3>

                            <p><a href="index.cfm?p=details&amp;searchme=978-1524759216" style="font-size: large">Eat a Peach</a>
                            </p>

                            <p><a href="index.cfm?p=details&amp;searchme=978-1419748684" style="font-size: large">The Deep End (Diary of a Wimpy Kid Book 15)</a></p>
                        </div>
